	...
	public static HBox createFxFileInputField(TextField textfield, FxUserInterface fxUI)
	{
		...
		b.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				java.io.File f = fxUI.showOpenFileDialog(de.akubix.keyminder.core.ApplicationInstance.APP_NAME + " - " + fxUI.getLocaleBundleString("filebrowser.dialogtitle"), "", "", new FileChooser.ExtensionFilter[]{new FileChooser.ExtensionFilter(fxUI.getLocaleBundleString("filebrowser.allfiles_selector"), "*.*")});
				if(f != null)
				{
