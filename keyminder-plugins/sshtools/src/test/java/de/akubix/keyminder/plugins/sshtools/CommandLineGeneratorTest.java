...
public class CommandLineGeneratorTest {
	...
	private static Supplier<InputStream> puttyCmdDescriptor = () -> CommandLineGeneratorTest.class.getResourceAsStream("/de/akubix/keyminder/plugins/sshtools/putty.xml");
	private static Supplier<InputStream>  winscpCmdDescriptor = () -> CommandLineGeneratorTest.class.getResourceAsStream("/de/akubix/keyminder/plugins/sshtools/winscp.xml");
